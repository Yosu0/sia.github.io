...
<title>Form Input Area Negara</title>
<style>
/* CSS */
h1 {
...
<div class="container">
    <h2>Form Input Area Negara</h2>
    <form action="../sia/process/process_negara.php" method="post">
        <div>
            <label for="id_negara">ID Negara:</label>
            <input type="text" id="id_negara" name="id_negara" required>
        </div>
        <div>
    ...
    <table>
        ...
        <tbody>
            ...
            if ($result && $result->num_rows > 0) {
                // Tampilkan data negara dalam tabel
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td class='id-negara'>" . $row["id_negara"] . "</td>";
                    echo "<td class='negara'>" . $row["negara"] . "</td>";
                    echo "</tr>";
                }
            } else {
                echo "<tr><td colspan='3'>Tidak ada hasil input negara.</td></tr>";
